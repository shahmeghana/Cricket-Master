 ...
 * org.springframework.jdbc.datasource.embedded.EmbeddedDatabase; import
 * org.springframework.jdbc.datasource.embedded.EmbeddedDatabaseBuilder; import
 * org.springframework.jdbc.datasource.embedded.EmbeddedDatabaseType; import
 ...
 *//**
	 ...
	 *//*
		 ...
		 * "com.nouhoun.springboot.jwt.integration.repository") public class
		 * DatasourceConfig {
		 * 
		 ...
		 * .addScript("sql-scripts/schema.sql") .addScript("sql-scripts/data.sql")
		 * .build();
		 * 
		 * return dataSource; }
		 * 
		 * @Bean public LocalContainerEntityManagerFactoryBean
		 * entityManagerFactory(@Qualifier("datasource") DataSource ds) throws
		 ...
		 * entityManagerFactory.setPackagesToScan(new
		 * String[]{"com.nouhoun.springboot.jwt.integration.domain"}); JpaVendorAdapter
